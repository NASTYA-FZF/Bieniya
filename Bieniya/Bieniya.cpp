...
// Bieniya.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CBieniyaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CBieniyaApp

CBieniyaApp::CBieniyaApp()
{
...
// Единственный объект CBieniyaApp

CBieniyaApp theApp;


// Инициализация CBieniyaApp

BOOL CBieniyaApp::InitInstance()
{
